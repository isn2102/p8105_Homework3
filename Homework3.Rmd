...
Create a plot showing activity over the course of the day, with each day of the week represented by a different color. For ease of viewing I have averaged the activity for each day of the week across the 5 weeks. **NOT SURE IF I SHOULD DO THIS**
```{r, message = FALSE}
accel_df %>% 
  ...
  geom_line(size = .2)
```
**GRAPH IS MESSY AND HARD TO READ**
**comments**  
Based on this graph I can see that the first ~300 minutes of the day have much less activity. There are some spikes in activity around 500-700 minutes and around 1300-1400 minutes. The spikes later in the day are particularly pronounced on Fridays.
